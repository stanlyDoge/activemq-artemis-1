...
public class DivertTopicToQueueTest extends JMSClientTestSupport {
   ...
   final private String address1 = "bss.order.workorderchanges.v1.topic";
   final private String address2 = "bss.order.Consumer.cbma.workorderchanges.v1.queue";
   final private String address3 = "bss.order.Consumer.pinpoint.workorderchanges.v1.queue";
